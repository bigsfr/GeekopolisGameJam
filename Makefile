...
EXTRA_DIST = ProjetOP.make rules.make configure Makefile.include Externals/GamepadBridge.dll Externals/GamepadConfigControls.dll Externals/Lidgren.Network.dll Externals/OpenTK.dll Externals/Tao.Sdl.dll Externals/MonoGame.Framework.Linux.dll
